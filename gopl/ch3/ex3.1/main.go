/*Exercício 3.1: Se a função f devolver um valor float64 não finito, o arquivo
SVG conterá elementos <polygon> inválidos (embora muitos
renderizadores SVG tratem essa situação com elegância). Modifique o
programa para ignorar polígonos inválidos que forem gerados.*/
